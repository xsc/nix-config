
{
  ...
  outputs = { self, darwin, nix-homebrew, homebrew-bundle, homebrew-core, homebrew-cask, home-manager, nixpkgs, disko, agenix, secrets, alacritty-theme } @inputs:
    let
    ...
    in
    {
      ...
      darwinConfigurations = let user = "yannick.scherer@futurice.com"; in {
